...
/**
 * Creates a JFrame window that contains the calculator. To launch, 
 * use the line "calculatorUI calc = new calculatorUI();" in the "Main" function
...
public class calculatorUI {
	...
	public calculatorUI(){
		...
		buttonBack.addActionListener(new ActionListener() {
			/**
			 * I am not sure what the exception possibly being thrown is,
			 * but it seems to work. Code retrieved from StackOverflow
